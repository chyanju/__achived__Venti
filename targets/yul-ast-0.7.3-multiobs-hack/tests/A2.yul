...
object "A2_34" {
    code {
        ...
        codecopy(0, dataoffset("A2_34_deployed"), datasize("A2_34_deployed"))

        return(0, datasize("A2_34_deployed"))

        function constructor_A2_34() {

        }

    }
    object "A2_34_deployed" {
        code {
            mstore(64, memoryguard(128))
            ...
            if iszero(lt(calldatasize(), 4))
            {
                ...
                case 0x709a3745
                {
                    ...
                    let ret_0 :=  fun_observe_0_33(param_0)
                    let memPos := allocateMemory(0)
            ...
            function fun_foo_21(vloc_x_7, vloc_y_9) {
                ...
                let expr_17 := 0x03e7
                let _1 := convert_t_rational_999_by_1_to_t_uint256(expr_17)
                let _2 := 0x00
                let expr_12 := _2
                let _3 := vloc_x_7
                let expr_13 := _3
                ...
                let _4 := mapping_index_access_t_mapping$_t_uint256_$_t_uint256_$_of_t_uint256(expr_12,expr_15)
                update_storage_value_offset_0t_uint256_to_t_uint256(_4, _1)
                let expr_18 := _1

            }

            function fun_observe_0_33(vloc_i_23) -> vloc__26 {
                let zero_value_for_type_t_uint256_5 := zero_value_for_split_t_uint256()
                vloc__26 := zero_value_for_type_t_uint256_5

                let _6 := 0x00
                let expr_28 := _6
                let _7 := vloc_i_23
                let expr_29 := _7
                let _8 := mapping_index_access_t_mapping$_t_uint256_$_t_uint256_$_of_t_uint256(expr_28,expr_29)
