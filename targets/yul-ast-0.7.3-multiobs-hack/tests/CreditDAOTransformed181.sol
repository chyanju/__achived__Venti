...
function observe__0() public view returns (uint256) {
return elections__1[(nextElectionIndex - 1)].nextCandidateIndex;
}
function observe__1() public view returns (bool) {
return elections__2[nextElectionIndex].candidateAddyToIndexMap_WRAP[msg.sender].t9bool_1_WRAP;
}
function observe__2() public view returns (uint256) {
return nextElectionIndex;
}
function observe__3() public view returns (uint256) {
return elections__2[nextElectionIndex].candidateAddyToIndexMap_WRAP[msg.sender].t7uint256_0_WRAP;
}
function observe__4() public view returns (bool) {
return elections__2[nextElectionIndex].candidateAddyToIndexMap_WRAP[msg.sender].t10bool_2_WRAP;
}
function observe__5() public view returns (uint256) {
return elections__2[nextElectionIndex].candidateVotes[elections__2[nextElectionIndex].candidateAddyToIndexMap_WRAP[msg.sender].t7uint256_0_WRAP];
}
