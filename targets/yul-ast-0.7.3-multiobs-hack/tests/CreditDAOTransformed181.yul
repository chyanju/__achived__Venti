...
object "CreditDAOTransformed181_567" {
    code {
        mstore(64, memoryguard(128))
        if callvalue() { revert(0, 0) }

        constructor_CreditDAOTransformed181_567()

        codecopy(0, dataoffset("CreditDAOTransformed181_567_deployed"), datasize("CreditDAOTransformed181_567_deployed"))

        return(0, datasize("CreditDAOTransformed181_567_deployed"))
        ...
        function constructor_CreditDAOTransformed181_567() {
    ...
    object "CreditDAOTransformed181_567_deployed" {
        code {
            mstore(64, memoryguard(128))
            ...
            if iszero(lt(calldatasize(), 4))
            {
                ...
                case 0x90a833f2
                {
                    ...
                    if callvalue() { revert(0, 0) }
                    let param_0 :=  abi_decode_tuple_t_uint256(4, calldatasize())
                    let ret_0 :=  fun_observe__8_566(param_0)
                    let memPos := allocateMemory(0)
                    let memEnd := abi_encode_tuple_t_bool__to_t_bool__fromStack(memPos , ret_0)
                    return(memPos, sub(memEnd, memPos))
                }
            ...
            function fun_observe__0_453() -> vloc__442 {
                let zero_value_for_type_t_uint256_217 := zero_value_for_split_t_uint256()
                vloc__442 := zero_value_for_type_t_uint256_217
                ...
                let expr_445 := _219
                let expr_446 := 0x01
                let expr_447 := checked_sub_t_uint256(expr_445, convert_t_rational_1_by_1_to_t_uint256(expr_446))

                let expr_448 := expr_447
                let _220 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Election_$14_storage_$_of_t_uint256(expr_444,expr_448)
                let _221_slot := _220
                let expr_449_slot := _221_slot
                let _222 := add(expr_449_slot, 3)
            ...
            function fun_observe__1_468() -> vloc__456 {
                let zero_value_for_type_t_bool_224 := zero_value_for_split_t_bool()
                vloc__456 := zero_value_for_type_t_bool_224

                let _225 := 0x02
                let expr_458 := _225
                let _226 := read_from_storage_offset_0_t_uint256(0x00)
                let expr_459 := _226
                let _227 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Foo_$31_storage_$_of_t_uint256(expr_458,expr_459)
                let _228_slot := _227
                let expr_460_slot := _228_slot
                let _229 := add(expr_460_slot, 1)
                let _230 := _229
                let expr_461 := _230
                let expr_463 := caller()
                let _231 := mapping_index_access_t_mapping$_t_address_$_t_struct$_Candidate_$38_storage_$_of_t_address_payable(expr_461,expr_463)
                let _232_slot := _231
                let expr_464_slot := _232_slot
                let _233 := add(expr_464_slot, 1)
            ...
            function fun_observe__2_476() -> vloc__471 {
                let zero_value_for_type_t_uint256_235 := zero_value_for_split_t_uint256()
                vloc__471 := zero_value_for_type_t_uint256_235
            ...
            function fun_observe__3_491() -> vloc__479 {
                let zero_value_for_type_t_uint256_237 := zero_value_for_split_t_uint256()
                vloc__479 := zero_value_for_type_t_uint256_237

                let _238 := 0x02
                let expr_481 := _238
                let _239 := read_from_storage_offset_0_t_uint256(0x00)
                let expr_482 := _239
                let _240 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Foo_$31_storage_$_of_t_uint256(expr_481,expr_482)
                let _241_slot := _240
                let expr_483_slot := _241_slot
                let _242 := add(expr_483_slot, 1)
                let _243 := _242
                let expr_484 := _243
                let expr_486 := caller()
                let _244 := mapping_index_access_t_mapping$_t_address_$_t_struct$_Candidate_$38_storage_$_of_t_address_payable(expr_484,expr_486)
                let _245_slot := _244
                let expr_487_slot := _245_slot
                let _246 := add(expr_487_slot, 0)
            ...
            function fun_observe__4_506() -> vloc__494 {
                let zero_value_for_type_t_bool_248 := zero_value_for_split_t_bool()
                vloc__494 := zero_value_for_type_t_bool_248

                let _249 := 0x02
                let expr_496 := _249
                let _250 := read_from_storage_offset_0_t_uint256(0x00)
                let expr_497 := _250
                let _251 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Foo_$31_storage_$_of_t_uint256(expr_496,expr_497)
                let _252_slot := _251
                let expr_498_slot := _252_slot
                let _253 := add(expr_498_slot, 1)
                let _254 := _253
                let expr_499 := _254
                let expr_501 := caller()
                let _255 := mapping_index_access_t_mapping$_t_address_$_t_struct$_Candidate_$38_storage_$_of_t_address_payable(expr_499,expr_501)
                let _256_slot := _255
                let expr_502_slot := _256_slot
                let _257 := add(expr_502_slot, 1)
            ...
            function fun_observe__5_526() -> vloc__509 {
                let zero_value_for_type_t_uint256_259 := zero_value_for_split_t_uint256()
                vloc__509 := zero_value_for_type_t_uint256_259

                let _260 := 0x02
                let expr_511 := _260
                let _261 := read_from_storage_offset_0_t_uint256(0x00)
                let expr_512 := _261
                let _262 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Foo_$31_storage_$_of_t_uint256(expr_511,expr_512)
                let _263_slot := _262
                let expr_513_slot := _263_slot
                let _264 := add(expr_513_slot, 0)
                let _265 := _264
                let expr_514 := _265
                let _266 := 0x02
                let expr_515 := _266
                let _267 := read_from_storage_offset_0_t_uint256(0x00)
                let expr_516 := _267
                let _268 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Foo_$31_storage_$_of_t_uint256(expr_515,expr_516)
                let _269_slot := _268
                let expr_517_slot := _269_slot
                let _270 := add(expr_517_slot, 1)
                let _271 := _270
                let expr_518 := _271
                let expr_520 := caller()
                let _272 := mapping_index_access_t_mapping$_t_address_$_t_struct$_Candidate_$38_storage_$_of_t_address_payable(expr_518,expr_520)
                let _273_slot := _272
                let expr_521_slot := _273_slot
                let _274 := add(expr_521_slot, 0)
                let _275 := read_from_storage_offset_0_t_uint256(_274)
                let expr_522 := _275
                let _276 := mapping_index_access_t_mapping$_t_uint256_$_t_uint256_$_of_t_uint256(expr_514,expr_522)
            ...
            function fun_observe__6_541() -> vloc__529 {
                let zero_value_for_type_t_uint256_278 := zero_value_for_split_t_uint256()
                vloc__529 := zero_value_for_type_t_uint256_278

                let _279 := 0x02
                let expr_531 := _279
                let _280 := read_from_storage_offset_0_t_uint256(0x00)
                let expr_532 := _280
                let _281 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Foo_$31_storage_$_of_t_uint256(expr_531,expr_532)
                let _282_slot := _281
                let expr_533_slot := _282_slot
                let _283 := add(expr_533_slot, 1)
                let _284 := _283
                let expr_534 := _284
                let expr_536 := caller()
                let _285 := mapping_index_access_t_mapping$_t_address_$_t_struct$_Candidate_$38_storage_$_of_t_address_payable(expr_534,expr_536)
                let _286_slot := _285
                let expr_537_slot := _286_slot
                let _287 := add(expr_537_slot, 0)
            ...
            function fun_observe__7_556() -> vloc__544 {
                let zero_value_for_type_t_bool_289 := zero_value_for_split_t_bool()
                vloc__544 := zero_value_for_type_t_bool_289

                let _290 := 0x02
                let expr_546 := _290
                let _291 := read_from_storage_offset_0_t_uint256(0x00)
                let expr_547 := _291
                let _292 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Foo_$31_storage_$_of_t_uint256(expr_546,expr_547)
                let _293_slot := _292
                let expr_548_slot := _293_slot
                let _294 := add(expr_548_slot, 1)
                let _295 := _294
                let expr_549 := _295
                let expr_551 := caller()
                let _296 := mapping_index_access_t_mapping$_t_address_$_t_struct$_Candidate_$38_storage_$_of_t_address_payable(expr_549,expr_551)
                let _297_slot := _296
                let expr_552_slot := _297_slot
                let _298 := add(expr_552_slot, 1)
            ...
            function fun_observe__8_566(vloc_i_558) -> vloc__561 {
                let zero_value_for_type_t_bool_300 := zero_value_for_split_t_bool()
                vloc__561 := zero_value_for_type_t_bool_300
