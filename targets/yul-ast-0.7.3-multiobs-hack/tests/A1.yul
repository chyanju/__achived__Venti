...
object "A1_32" {
    code {
        ...
        codecopy(0, dataoffset("A1_32_deployed"), datasize("A1_32_deployed"))

        return(0, datasize("A1_32_deployed"))

        function constructor_A1_32() {

        }

    }
    object "A1_32_deployed" {
        code {
            mstore(64, memoryguard(128))
            ...
            function fun_foo_19(vloc_x_7, vloc_y_9) {
                ...
                let _3 := vloc_x_7
                let expr_13 := _3
                let _4 := mapping_index_access_t_mapping$_t_uint256_$_t_uint256_$_of_t_uint256(expr_12,expr_13)
