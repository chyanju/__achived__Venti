...
object "MulRetsB_50" {
    code {
        ...
        constructor_MulRetsB_50()

        codecopy(0, dataoffset("MulRetsB_50_deployed"), datasize("MulRetsB_50_deployed"))

        return(0, datasize("MulRetsB_50_deployed"))

        function cleanup_t_uint256(value) -> cleaned {
            cleaned := value
        }

        function constructor_MulRetsB_50() {

            let expr_9 := 0x03
            let _1 := convert_t_rational_3_by_1_to_t_uint256(expr_9)
            update_storage_value_offset_0t_uint256_to_t_uint256(0x00, _1)
            let expr_10 := _1
            let expr_13 := 0x04
            let _2 := convert_t_rational_4_by_1_to_t_uint256(expr_13)
