...
object "B8_32" {
    code {
        ...
        codecopy(0, dataoffset("B8_32_deployed"), datasize("B8_32_deployed"))

        return(0, datasize("B8_32_deployed"))

        function constructor_B8_32() {

        }

    }
    object "B8_32_deployed" {
        code {
            mstore(64, memoryguard(128))
            ...
            function convert_t_rational_555_by_1_to_t_uint256(value) -> converted {
            ...
            function fun_modify_pos_17(vloc_pos_7) {
                ...
                let expr_13 := 0x022b
                let _1 := convert_t_rational_555_by_1_to_t_uint256(expr_13)
                let _2 := 0x00
                let expr_10 := _2
                let _3 := vloc_pos_7
                let expr_11 := _3
