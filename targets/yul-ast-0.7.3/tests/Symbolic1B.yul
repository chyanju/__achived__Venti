...
object "Symbolic1B_32" {
    code {
        mstore(64, memoryguard(128))
        if callvalue() { revert(0, 0) }

        constructor_Symbolic1B_32()

        codecopy(0, dataoffset("Symbolic1B_32_deployed"), datasize("Symbolic1B_32_deployed"))

        return(0, datasize("Symbolic1B_32_deployed"))

        function cleanup_t_uint256(value) -> cleaned {
            cleaned := value
        }

        function constructor_Symbolic1B_32() {

            let expr_7 := 0x07
            let _1 := convert_t_rational_7_by_1_to_t_uint256(expr_7)
