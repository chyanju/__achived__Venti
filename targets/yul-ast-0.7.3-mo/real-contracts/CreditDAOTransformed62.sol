...
contract CreditDAOTransformed62 {
struct Election {
...
require(!elections__2[1].candidateAddyToIndexMap_WRAP[msg.sender].t9bool_1_WRAP);
uint256 nextCandidateId;
nextCandidateId = elections__1[nextElectionIndex].nextCandidateIndex;
elections__2[nextElectionIndex].candidateIndex[nextCandidateId] = msg.sender;
if (false) {
elections__2[1].candidateAddyToIndexMap_WRAP[msg.sender].t7uint256_0_WRAP = nextCandidateId;
}
...
uint256 candidateId;
candidateId = elections__2[1].candidateAddyToIndexMap_WRAP[_participant].t7uint256_0_WRAP;
...
creditCEO = elections__2[1].maxVotes;
