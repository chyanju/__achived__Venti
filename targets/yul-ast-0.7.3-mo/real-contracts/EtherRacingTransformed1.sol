...
contract EtherRacingTransformed1 is Ownable {
struct Customer {
	bytes32 name;
	uint256 earned;
	uint16 c_num;
...
struct Foo {
	/* t1 ->*/ uint16 t1uint16_0_WRAP;
	/* t2 ->*/ uint16 t2uint16_1_WRAP;
	/* t3 ->*/ uint8 t3uint8_2_WRAP;
	/* t4 ->*/ uint8 t4uint8_3_WRAP;
	/* t5 ->*/ uint8 t5uint8_4_WRAP;
	/* t6 ->*/ uint8 t6uint8_5_WRAP;
	/* t7 ->*/ uint8 t7uint8_6_WRAP;
}
