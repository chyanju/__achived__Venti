...
object "CreditDAOTransformed1_573" {
    code {
        mstore(64, memoryguard(128))
        if callvalue() { revert(0, 0) }

        constructor_CreditDAOTransformed1_573()

        codecopy(0, dataoffset("CreditDAOTransformed1_573_deployed"), datasize("CreditDAOTransformed1_573_deployed"))

        return(0, datasize("CreditDAOTransformed1_573_deployed"))
        ...
        function constructor_CreditDAOTransformed1_573() {
    ...
    object "CreditDAOTransformed1_573_deployed" {
        code {
            mstore(64, memoryguard(128))
            ...
            if iszero(lt(calldatasize(), 4))
            {
                ...
                case 0x5467d725
                {
                    ...
                    if callvalue() { revert(0, 0) }
                    let param_0 :=  abi_decode_tuple_t_uint256(4, calldatasize())
                    let ret_0 :=  fun_observe__6_546(param_0)
                    let memPos := allocateMemory(0)
                    let memEnd := abi_encode_tuple_t_uint256__to_t_uint256__fromStack(memPos , ret_0)
                    return(memPos, sub(memEnd, memPos))
                }
                ...
                case 0x5c647684
                {
                    ...
                    if callvalue() { revert(0, 0) }
                    let param_0 :=  abi_decode_tuple_t_uint256(4, calldatasize())
                    let ret_0 :=  fun_observe__7_559(param_0)
                    let memPos := allocateMemory(0)
                    let memEnd := abi_encode_tuple_t_uint256__to_t_uint256__fromStack(memPos , ret_0)
                    return(memPos, sub(memEnd, memPos))
                }
                ...
                case 0x90a833f2
                {
                    ...
                    if callvalue() { revert(0, 0) }
                    let param_0 :=  abi_decode_tuple_t_uint256(4, calldatasize())
                    let ret_0 :=  fun_observe__8_572(param_0)
                    let memPos := allocateMemory(0)
                    let memEnd := abi_encode_tuple_t_uint256__to_t_uint256__fromStack(memPos , ret_0)
                    return(memPos, sub(memEnd, memPos))
                }
            ...
            function fun_finishElections_439(vloc__iterations_284) {

                let vloc_curentVotes_288
                let zero_value_for_type_t_uint256_120 := zero_value_for_split_t_uint256()
                vloc_curentVotes_288 := zero_value_for_type_t_uint256_120
                let vloc_nextCandidateId_291
                let zero_value_for_type_t_uint256_121 := zero_value_for_split_t_uint256()
                vloc_nextCandidateId_291 := zero_value_for_type_t_uint256_121
                let _122 := 0x01
                let expr_294 := _122
                let _123 := read_from_storage_offset_0_t_uint256(0x00)
                let expr_295 := _123
                let expr_296 := 0x01
                let expr_297 := checked_sub_t_uint256(expr_295, convert_t_rational_1_by_1_to_t_uint256(expr_296))

                let expr_298 := expr_297
                let _124 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Election_$14_storage_$_of_t_uint256(expr_294,expr_298)
                let _125_slot := _124
                let expr_299_slot := _125_slot
                let _126 := add(expr_299_slot, 5)
                let _127 := read_from_storage_offset_0_t_uint256(_126)
                let expr_300 := _127
                vloc_nextCandidateId_291 := expr_300
                let expr_301 := expr_300
                let vloc_cnt_304
                let zero_value_for_type_t_uint256_128 := zero_value_for_split_t_uint256()
                vloc_cnt_304 := zero_value_for_type_t_uint256_128
                let expr_307 := 0x00
                let _129 := convert_t_rational_0_by_1_to_t_uint256(expr_307)
                vloc_cnt_304 := _129
                let expr_308 := _129
                for {
                    } 1 {
                ...
                {
                    let _130 := vloc_cnt_304
                    let expr_310 := _130
                    let _131 := vloc__iterations_284
                    let expr_311 := _131
                    let expr_312 := lt(cleanup_t_uint256(expr_310), cleanup_t_uint256(expr_311))
                    let expr_313 := expr_312
                    if iszero(expr_313) { break }
                    let _132 := 0x02
                    let expr_315 := _132
                    let _133 := read_from_storage_offset_0_t_uint256(0x00)
                    let expr_316 := _133
                    let _134 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Foo_$31_storage_$_of_t_uint256(expr_315,expr_316)
                    let _135_slot := _134
                    let expr_317_slot := _135_slot
                    let _136 := add(expr_317_slot, 0)
                    let _137 := _136
                    let expr_318 := _137
                    let _138 := vloc_nextCandidateId_291
                    let expr_319 := _138
                    ...
                    let expr_320 := _140
                    vloc_curentVotes_288 := expr_320
                    let expr_321 := expr_320
                    let _141 := vloc_curentVotes_288
                    let expr_323 := _141
                    let _142 := 0x01
                    let expr_324 := _142
                    ...
                    if expr_332 {
                        ...
                        let _153 := _152
                        let expr_340 := _153
                        let _154 := vloc_nextCandidateId_291
                        let expr_341 := _154
                    ...
                    let _169 := vloc_nextCandidateId_291
                    let _168 := increment_t_uint256(_169)
                    vloc_nextCandidateId_291 := _168
                    let expr_358 := _169
                    let _171 := vloc_cnt_304
                    let _170 := increment_t_uint256(_171)
                    vloc_cnt_304 := _170
                    let expr_361 := _171
                }
                let _172 := vloc_nextCandidateId_291
                let expr_373 := _172
                let _173 := 0x01
                let expr_366 := _173
                ...
                let _183 := _182
                let expr_379 := _183
                let _184 := vloc_nextCandidateId_291
                let expr_380 := _184
            ...
            function fun_observe__6_546(vloc_i_535) -> vloc__538 {
                ...
                let _280 := vloc_i_535
                let expr_541 := _280
                let _281 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Election_$14_storage_$_of_t_uint256(expr_540,expr_541)
                let _282_slot := _281
                let expr_542_slot := _282_slot
                let _283 := add(expr_542_slot, 4)
            ...
            function fun_observe__7_559(vloc_i_548) -> vloc__551 {
                let zero_value_for_type_t_uint256_285 := zero_value_for_split_t_uint256()
                vloc__551 := zero_value_for_type_t_uint256_285

                let _286 := 0x01
                let expr_553 := _286
                let _287 := vloc_i_548
                let expr_554 := _287
                let _288 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Election_$14_storage_$_of_t_uint256(expr_553,expr_554)
                let _289_slot := _288
                let expr_555_slot := _289_slot
                let _290 := add(expr_555_slot, 1)
            ...
            function fun_observe__8_572(vloc_i_561) -> vloc__564 {
                let zero_value_for_type_t_uint256_292 := zero_value_for_split_t_uint256()
                vloc__564 := zero_value_for_type_t_uint256_292

                let _293 := 0x01
                let expr_566 := _293
                let _294 := vloc_i_561
                let expr_567 := _294
                let _295 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Election_$14_storage_$_of_t_uint256(expr_566,expr_567)
                let _296_slot := _295
                let expr_568_slot := _296_slot
                let _297 := add(expr_568_slot, 0)
            ...
            function fun_vote_282(vloc__participant_216) {
                ...
                let expr_264 := 0x01
                let _101 := convert_t_rational_1_by_1_to_t_uint256(expr_264)
                let _102 := 0x02
                let expr_258 := _102
                let _103 := read_from_storage_offset_0_t_uint256(0x00)
                let expr_259 := _103
                let _104 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Foo_$31_storage_$_of_t_uint256(expr_258,expr_259)
                let _105_slot := _104
                let expr_260_slot := _105_slot
                let _106 := add(expr_260_slot, 0)
                let _107 := _106
                let expr_261 := _107
                let _108 := vloc_candidateId_246
                let expr_262 := _108
                let _109 := mapping_index_access_t_mapping$_t_uint256_$_t_uint256_$_of_t_uint256(expr_261,expr_262)
                ...
                if expr_267 {
                    ...
                    let expr_269 := _112
                    let _113 := mapping_index_access_t_mapping$_t_uint256_$_t_struct$_Foo_$31_storage_$_of_t_uint256(expr_268,expr_269)
                    let _114_slot := _113
                    let expr_270_slot := _114_slot
                    let _115 := add(expr_270_slot, 1)
                    let _116 := _115
                    let expr_271 := _116
                    let expr_273 := caller()
                    let _117 := mapping_index_access_t_mapping$_t_address_$_t_struct$_Candidate_$38_storage_$_of_t_address_payable(expr_271,expr_273)
                    let _118_slot := _117
                    let expr_274_slot := _118_slot
                    let _119 := add(expr_274_slot, 1)
                    update_storage_value_offset_1t_bool_to_t_bool(_119, expr_276)
