...
object "B1_54" {
    code {
        ...
        codecopy(0, dataoffset("B1_54_deployed"), datasize("B1_54_deployed"))

        return(0, datasize("B1_54_deployed"))

        function constructor_B1_54() {

        }

    }
    object "B1_54_deployed" {
        code {
            mstore(64, memoryguard(128))
